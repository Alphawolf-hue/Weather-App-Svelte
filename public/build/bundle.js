...
var app = (function () {
	...
	function create_fragment$3(ctx) {
		...
		const block = {
			c: function create() {
				div = element("div");
				attr_dev(div, "id", "openweathermap-widget-11");
	...
	function instance$3($$self, $$props) {
		...
		window.myWidgetParam.push({
			id: 11,
			cityid: "2643743",
			appid: "8d8247022223ca9e1d9a07e3f75907574",
			units: "metric",
	...
	/* src\components\Weather.svelte generated by Svelte v3.37.0 */
	const file$2 = "src\\components\\Weather.svelte";
	...
	function create_fragment$2(ctx) {
		...
		const block = {
			c: function create() {
				...
				t8 = text("Wind Speed\r\n      ");
				p1 = element("p");
				t9 = text(/*windSpeed*/ ctx[1]);
				t10 = text(" km/h");
				t11 = space();
				div6 = element("div");
				t12 = text("Humidity\r\n    ");
				p2 = element("p");
				t13 = text(/*humidity*/ ctx[2]);
				t14 = text(" %");
				attr_dev(span, "id", "date-time");
				add_location(span, file$2, 12, 49, 315);
				attr_dev(p0, "class", "uk-text-meta uk-margin-remove-top");
				add_location(p0, file$2, 12, 4, 270);
				attr_dev(div0, "class", "uk-card-header uk-padding-top uk-margin-remove");
				add_location(div0, file$2, 11, 0, 204);
				attr_dev(img, "class", "uk-margin-remove");
				attr_dev(img, "width", "80");
				attr_dev(img, "height", "80");
				attr_dev(img, "alt", "weather icon");
				attr_dev(img, "id", "icon");
				add_location(img, file$2, 17, 6, 495);
				attr_dev(div1, "class", "uk-width-1-2@m uk-flex-first");
				add_location(div1, file$2, 16, 4, 445);
				attr_dev(h1, "class", "uk-margin-remove");
				add_location(h1, file$2, 20, 6, 632);
				attr_dev(div2, "class", "uk-width-1-2@m");
				add_location(div2, file$2, 19, 4, 596);
				attr_dev(div3, "class", "uk-flex uk-margin");
				add_location(div3, file$2, 15, 2, 408);
				attr_dev(h3, "class", "uk-margin-remove");
				add_location(h3, file$2, 23, 2, 708);
				attr_dev(div4, "class", "uk-card-body uk-padding-small");
				add_location(div4, file$2, 14, 0, 361);
				add_location(p1, file$2, 29, 6, 892);
				attr_dev(div5, "class", "uk-width-1-2@m uk-flex-first");
				add_location(div5, file$2, 27, 4, 824);
				add_location(p2, file$2, 33, 4, 983);
				attr_dev(div6, "class", "uk-width-1-2@m");
				add_location(div6, file$2, 31, 4, 933);
				attr_dev(div7, "class", "uk-flex");
				add_location(div7, file$2, 26, 2, 797);
				attr_dev(div8, "class", "uk-card-footer");
				add_location(div8, file$2, 25, 0, 765);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
			...
			p: function update(ctx, [dirty]) {
				if (dirty & /*temperature*/ 8) set_data_dev(t3, /*temperature*/ ctx[3]);
				if (dirty & /*description*/ 1) set_data_dev(t6, /*description*/ ctx[0]);
				if (dirty & /*windSpeed*/ 2) set_data_dev(t9, /*windSpeed*/ ctx[1]);
				if (dirty & /*humidity*/ 4) set_data_dev(t13, /*humidity*/ ctx[2]);
			},
			i: noop,
			o: noop,
			d: function destroy(detaching) {
	...
	function instance$2($$self, $$props, $$invalidate) {
		...
		const writable_props = ["description", "windSpeed", "humidity", "temperature"];
		...
		$$self.$$set = $$props => {
			...
			if ("windSpeed" in $$props) $$invalidate(1, windSpeed = $$props.windSpeed);
			if ("humidity" in $$props) $$invalidate(2, humidity = $$props.humidity);
		...
		return [description, windSpeed, humidity, temperature, dt];
	}
	...
	class Weather extends SvelteComponentDev {
		constructor(options) {
			...
			if (/*description*/ ctx[0] === undefined && !("description" in props)) {
				console.warn("<Weather> was created without expected prop 'description'");
			}

			if (/*windSpeed*/ ctx[1] === undefined && !("windSpeed" in props)) {
				console.warn("<Weather> was created without expected prop 'windSpeed'");
			}

			if (/*humidity*/ ctx[2] === undefined && !("humidity" in props)) {
				console.warn("<Weather> was created without expected prop 'humidity'");
			}

			if (/*temperature*/ ctx[3] === undefined && !("temperature" in props)) {
				console.warn("<Weather> was created without expected prop 'temperature'");
			}
		}
	...
	/* src\layout\Navbar.svelte generated by Svelte v3.37.0 */
	...
	function create_fragment$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(li0, file$1, 7, 20, 244);
				add_location(li1, file$1, 8, 20, 312);
				attr_dev(li2, "class", "uk-active");
				add_location(li2, file$1, 13, 32, 573);
				add_location(li3, file$1, 14, 32, 653);
				attr_dev(li4, "class", "uk-nav-header");
				add_location(li4, file$1, 15, 32, 713);
				add_location(li5, file$1, 16, 32, 784);
				add_location(li6, file$1, 17, 32, 844);
				attr_dev(li7, "class", "uk-nav-divider");
				add_location(li7, file$1, 18, 32, 904);
				add_location(li8, file$1, 19, 32, 970);
				attr_dev(ul0, "class", "uk-nav uk-navbar-dropdown-nav");
				add_location(ul0, file$1, 12, 28, 497);
				attr_dev(div0, "class", "uk-navbar-dropdown");
				add_location(div0, file$1, 11, 24, 435);
				add_location(li9, file$1, 9, 20, 360);
				attr_dev(ul1, "class", "uk-navbar-nav");
				add_location(ul1, file$1, 6, 16, 196);
				attr_dev(div1, "class", "uk-navbar-left");
				add_location(div1, file$1, 5, 12, 150);
				attr_dev(nav, "class", "uk-navbar-container uk-navbar-transparent");
				attr_dev(nav, "uk-navbar", "");
				add_location(nav, file$1, 4, 8, 71);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
			m: function mount(target, anchor) {
				...
				append_dev(ul1, t1);
				append_dev(ul1, li9);
				mount_component(link2, li9, null);
				append_dev(li9, t2);
				append_dev(li9, div0);
				append_dev(div0, ul0);
				append_dev(ul0, li2);
				...
				append_dev(ul0, t9);
				append_dev(ul0, li8);
				mount_component(link7, li8, null);
				current = true;
			},
			p: function update(ctx, [dirty]) {
				const link0_changes = {};
	...
	function create_fragment(ctx) {
		...
		weather = new Weather({
				props: {
					...
					temperature: /*temperature*/ ctx[4],
					humidity: /*humidity*/ ctx[3],
					windSpeed: /*windSpeed*/ ctx[2]
				},
				$$inline: true
			});
		...
		const block = {
			c: function create() {
				...
				div7 = element("div");
				div5 = element("div");
				div5.textContent = "today";
				t11 = space();
				div6 = element("div");
				div6.textContent = "humidity";
				t13 = space();
				div12 = element("div");
				div11 = element("div");
				div9 = element("div");
				div9.textContent = "tomorrow";
				t15 = space();
				div10 = element("div");
				div10.textContent = "humidity";
				t17 = space();
				div16 = element("div");
				div15 = element("div");
				div13 = element("div");
				div13.textContent = "next 2 days";
				t19 = space();
				div14 = element("div");
				div14.textContent = "humidity";
				attr_dev(h1, "class", "svelte-1t8f4sy");
				add_location(h1, file, 58, 1, 1435);
				attr_dev(input, "type", "text");
				attr_dev(input, "id", "city");
				attr_dev(input, "placeholder", "Enter city");
				add_location(input, file, 67, 7, 1787);
				attr_dev(span, "uk-icon", "icon: search");
				add_location(span, file, 68, 65, 1928);
				attr_dev(button, "class", "uk-button uk-button-default");
				attr_dev(button, "type", "submit");
				add_location(button, file, 68, 7, 1870);
				add_location(h3, file, 69, 7, 1982);
				attr_dev(div0, "class", "uk-grid-column-small uk-grid-row-large uk-padding uk-padding-remove-top");
				attr_dev(div0, "uk-grid", "");
				add_location(div0, file, 66, 6, 1685);
				add_location(form, file, 65, 5, 1650);
				attr_dev(div1, "class", "uk-flex");
				add_location(div1, file, 64, 4, 1622);
				attr_dev(div2, "class", "uk-card uk-card-default uk-card-body uk-margin-right uk-width-1-3@m uk-padding-remove ");
				add_location(div2, file, 75, 6, 2180);
				attr_dev(div3, "class", "uk-card uk-card-default uk-card-body");
				add_location(div3, file, 85, 8, 2624);
				attr_dev(div4, "class", "uk-width-1-1@m uk-padding  uk-padding-remove-bottom");
				add_location(div4, file, 84, 7, 2549);
				attr_dev(div5, "class", "uk-card-title");
				add_location(div5, file, 93, 11, 2926);
				attr_dev(div6, "class", "uk-card-body");
				add_location(div6, file, 94, 11, 2977);
				attr_dev(div7, "class", "uk-card uk-card-small uk-card-primary uk-card-body");
				add_location(div7, file, 92, 10, 2849);
				add_location(div8, file, 91, 9, 2832);
				attr_dev(div9, "class", "uk-card-title");
				add_location(div9, file, 99, 11, 3158);
				attr_dev(div10, "class", "uk-card-body");
				add_location(div10, file, 100, 11, 3212);
				attr_dev(div11, "class", "uk-card uk-card-small uk-card-default uk-card-body");
				add_location(div11, file, 98, 10, 3081);
				add_location(div12, file, 97, 9, 3064);
				attr_dev(div13, "class", "uk-card-title");
				add_location(div13, file, 105, 11, 3392);
				attr_dev(div14, "class", "uk-card-body");
				add_location(div14, file, 106, 11, 3449);
				attr_dev(div15, "class", "uk-card uk-card-small uk-card-default uk-card-body");
				add_location(div15, file, 104, 10, 3315);
				add_location(div16, file, 103, 9, 3298);
				attr_dev(div17, "class", "uk-child-width-1-3@m uk-grid-small uk-grid-match uk-padding");
				attr_dev(div17, "uk-grid", "");
				add_location(div17, file, 90, 8, 2740);
				add_location(div18, file, 89, 7, 2725);
				attr_dev(div19, "class", "uk-card uk-card-default uk-margin-left uk-card-body uk-padding-remove");
				add_location(div19, file, 83, 6, 2457);
				attr_dev(div20, "class", "uk-grid-match uk-child-width-expand@m");
				attr_dev(div20, "uk-grid", "");
				add_location(div20, file, 74, 5, 2113);
				attr_dev(div21, "class", "uk-container");
				attr_dev(div21, "background-color", "blue");
				add_location(div21, file, 73, 4, 2056);
				attr_dev(div22, "class", "uk-section uk-section-xlarge uk-section-muted uk-padding-large");
				add_location(div22, file, 63, 3, 1540);
				attr_dev(div23, "class", "uk-padding-small");
				add_location(div23, file, 62, 3, 1505);
				attr_dev(main, "class", "uk-height-large  uk-padding-remove-top svelte-1t8f4sy");
				add_location(main, file, 57, 0, 1378);
			},
			l: function claim(nodes) {
			...
			p: function update(ctx, [dirty]) {
				...
				if (!current || dirty & /*city*/ 1) set_data_dev(t6, /*city*/ ctx[0]);
				const weather_changes = {};
				if (dirty & /*description*/ 2) weather_changes.description = /*description*/ ctx[1];
				if (dirty & /*temperature*/ 16) weather_changes.temperature = /*temperature*/ ctx[4];
				if (dirty & /*humidity*/ 8) weather_changes.humidity = /*humidity*/ ctx[3];
				if (dirty & /*windSpeed*/ 4) weather_changes.windSpeed = /*windSpeed*/ ctx[2];
	...
	function fetchWeather(city) {
		return fetch("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=metric&appid=8d8247022223ca9e1d9a07e3f7590757").then(response => {
			if (!response.ok) {
	...
	function instance($$self, $$props, $$invalidate) {
		...
		function displayWeather(res) {
			data = res;
			$$invalidate(1, description = data.weather[0].description);
			$$invalidate(4, temperature = data.main.temp);
			$$invalidate(2, windSpeed = data.wind.speed);
			$$invalidate(3, humidity = data.main.humidity);
		...
		$$self.$inject_state = $$props => {
			...
			if ("windSpeed" in $$props) $$invalidate(2, windSpeed = $$props.windSpeed);
